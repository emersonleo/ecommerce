...
<script type="text/javascript">
	...
	function construirCards(JSONProdutos){
		...
		for (var i = 0; i <= JSONProdutos.length - 1; i++) {
			...
			let botoes = '<div class="form-group " style="justify-content:center"> <button class="btn btn-success" data-id="' + JSONProdutos[i].id + '" onclick="addCarrinho(this)"> <h6> Adicionar ao carrinho </h6> </button> </div>'
